   ...
   let startButton = document.getElementById("startButton"); // Başlat butonunu seç
   let stopButton = document.getElementById("stopButton"); // Durdur butonunu seç
   let downloadLinks = document.getElementById("downloadLinks"); // İndirme bağlantılarını seç
   let volumeSlider = document.getElementById("volumeSlider"); // Ses seviyesi kaydırma çubuğu
...
// Ses seviyesi kaydırma çubuğu değiştiğinde
